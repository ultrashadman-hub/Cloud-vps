...
Owner: LEADER SHADMAN / LEADER_SHADMAN
"""
...
OWNER_USER = "SHADMAN"
OWNER_PASS = "LEADER123"

DEFAULT_PRICING = {
    "currency": "$",
    "contact": "Telegram: @IshrakShadman",
    "plans": [
        {"name": "Starter", "duration": "24 Hours",  "price": "0.50",  "features": "1 file run, 512MB RAM, Real-time logs"},
        {"name": "Basic",   "duration": "7 Days",    "price": "1.50", "features": "Multi-file upload, pip/npm install, 24/7 uptime"},
        {"name": "Pro",     "duration": "30 Days",   "price": "4", "features": "Unlimited modules, Priority support, Auto-restart"},
        {"name": "Premium", "duration": "Lifetime",  "price": "18","features": "All features, Custom domain, Dedicated help"},
    ],
}
